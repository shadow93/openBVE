...
namespace OpenBveApi.Math {
	...
	public struct Vector3D {
		...
		public void Translate(Orientation3 orientation, Vector3D offset) {
		...
		/// <param name="orientation">The orientation.</param>
		/// <param name="offset">The offset measured in the specified orientation.</param>
		public static Vector3D Translate(Vector3D vector, Orientation3 orientation, Vector3D offset) {
		...
		/// <param name="Y">The Y-coordinate.</param>
		public static Vector3D GetVector3(Vector2D Vector, double Y) {
